...
const NAV_ITEMS = [
  ...
  { href: '/#projects', id: 'projects', label: 'Work', icon: RulerPenIcon },
  { href: '/#experience', id: 'experience', label: 'Experience', icon: ProgrammingIcon },
  { href: '/#achievements', id: 'achievements', label: 'Awards', icon: TrophyIcon }
]
        ...
        {NAV_ITEMS.map(item => (
          <Link
            ...
            className={cn(
              ...
              item.id === activeId ? 'text-accent bg-accent/10' : 'text-muted-foreground'
            )}
          >
