    ...
    <section id='about' className='border-b py-8 sm:py-16 lg:py-24'>
      <div className='mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:space-y-16 lg:px-10.5'>
        <div className='space-y-2'>
          ...
          <h2 className='text-2xl font-semibold md:text-3xl lg:text-4xl'>The engineer behind the systems</h2>
        </div>

        <div className='max-w-3xl space-y-4'>
          {profile.summary.map(paragraph => (
            <p key={paragraph} className='text-muted-foreground text-base sm:text-lg'>
              {paragraph}
            </p>
          ))}
