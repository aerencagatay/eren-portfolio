...
// TODO(eren): replace /public/images/about-me/folder-01..03.webp with your own
// photos and set the label + count below.
    ...
    >
      <CardContent>
        <div className='group/folder relative flex aspect-video items-end justify-center'>
          ...
          {PHOTOS.map((photo, i) => (
            ...
            >
              <img src={asset(photo.src)} alt='folder images' className='object-cover' />
            </div>
          ))}
          ...
          >
            <img src={asset('/images/about-me/folder-front.webp')} alt='folder front' className='w-40' />
          </div>
        </div>
      </CardContent>
      ...
      <CardContent>
        <div className='flex items-center justify-center gap-3'>
          <p className='text-foreground text-xl font-medium text-nowrap xl:text-[26px]'>Travel</p>
          <Badge
            variant='secondary'
