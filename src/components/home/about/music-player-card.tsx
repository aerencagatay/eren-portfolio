...
// TODO(eren): decorative 'now playing' widget. Swap the track name/artist below
// and /public/images/about-me/music.webp + eye.webp for something of yours.
...
const MusicPlayerCard = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src={asset('/images/about-me/music.webp')}
      ...
      >
        <div className='ring-background/40 relative size-8 overflow-hidden rounded-full ring-2'>
          <Image src={asset('/images/about-me/eye.webp')} alt='eye image' fill sizes='auto' className='object-cover' />
        </div>
      </div>
