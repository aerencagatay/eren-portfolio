...
// TODO(eren): the notes below are the template's placeholder jokes — rewrite them
// in your own voice (or delete this card from about.tsx).
...
const SurpriseNote = () => {
  ...
  return (
    <div className='relative h-full'>
      ...
      >
        <img src={asset('/images/about-me/note.webp')} alt='Note bg' className='w-full' />
